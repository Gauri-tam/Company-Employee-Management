...
public interface DepartmentRepo  extends JpaRepository<Department, Integer> {
    ...
    @Query(value = "select d.dept_id, d.dept_name, d.dept_no,e.emp_id, e.emp_name, e.emp_name, e.emp_role from Department d left join Employee e on e.dept_id = d.dept_id where e.emp_role like %:empRole%", nativeQuery = true)
    Page<Department> findAllDeptByRole(Pageable pageable,@Param("empRole") String empRole);
